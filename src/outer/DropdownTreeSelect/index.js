...
class DropdownTreeSelect extends Component {
    ...
    //tvv \/
    init(props) {
        const tree = this.createList(
            props.data,
            props.simpleSelect,
            props.showPartiallySelected
        );
        const tags = this.treeManager.getTags();

        if (props.simpleSelect && tags.length) {
            //tvv no init for simple
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            this.state.showDropdown !== !nextProps.forceCloseDropDown &&
            this.state.showDropdown
        )
            this.handleClick(); //tvv
    }
    ...
    handleClick = () => {
        this.setState(prevState => {
            ...
            const showDropdown =
                this.keepDropdownActive || !prevState.showDropdown;
                            ...
                            {this.state.allNodesHidden ? (
                                ...
                                <Tree
                                    ...
                                    showPartiallySelected={
                                        this.props.showPartiallySelected
                                    }
                                    readOnly={this.props.readOnly}
                                />
                            )}
