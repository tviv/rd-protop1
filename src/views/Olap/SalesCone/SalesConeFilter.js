                    ...
                    <Col xs="12" lg="3">
                        <FormGroup>
                            ...
                            <Input
                                ...
                                name="date-input"
                                placeholder="date"
                                value={model.filters.periodFilter.date}
                ...
                <Row>
                    <Col xs="12" lg="3">
                        <FormGroup>
                            <Label htmlFor="feature-select">
                                Признаки номеклатуры
                            </Label>
                            <WrappedSelect
                                name="feature-select"
                                hierarchyName="[Признаки товара].[Категории]"
                            />
                        </FormGroup>
                    </Col>
                    <Col xs="12" lg="3">
                        <FormGroup>
                            ...
                            <WrappedSelect
                                name="suppl-select"
                                hierarchyName="[Товары].[Поставщик]"
                                alwaysSearch
                            />
                        </FormGroup>
                    </Col>
                    <Col xs="12" lg="4">
                        <FormGroup>
                            ...
                            <WrappedSelect
                                name="manaf-select"
                                hierarchyName="[Товары].[Производитель]"
                                alwaysSearch
                            />
                        </FormGroup>
                    </Col>
